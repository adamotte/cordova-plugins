...
public class GCMIntentService extends GCMBaseIntentService {
	...
	public void createNotification(Context context, Bundle extras)
	{
		...
		mBuilder.setStyle(new NotificationCompat.BigTextStyle().bigText(message).setBigContentTitle(ticker));
	...
	private void setIcons(final NotificationCompat.Builder builder, final Context context, final Bundle extras, final IIconBuilderClient client) {
		...
		// Get large icon
		final String largeIconName = extras.getString("largeIcon");
		if (null != largeIconName && false == largeIconName.equals("")) {
			Log.d("GCMIntentService", "found large icon in payload : " + largeIconName);
			final int largeIconId = res.getIdentifier(largeIconName, "drawable", context.getPackageName());
